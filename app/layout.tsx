            ...
            <div className="flex justify-between items-center h-20">
              ...
              <Link href="/" className="flex items-center group">
                ...
                <div className="transition-all duration-300 group-hover:translate-x-1">
                  {/* Updated: Single line, smaller but bold */}
                  <span className="text-base font-black bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent block leading-tight">
