    ...
    try {
      const response = await fetch('https://formsubmit.co/ajax/info@uesenergysolutions.com', {
        ...
        body: JSON.stringify({
          ...
          _subject: 'New Quote Request from UES Website',
          _cc: 'ceo@uesenergysolutions.com'  // CC to CEO
        })
      })
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-blue-900 text-white py-3 rounded-lg font-semibold hover:bg-blue-800 transition-colors flex items-center justify-center disabled:opacity-50"
                  >
                    {submitting ? (
                      <>
