        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              <span className="font-semibold text-blue-900">UES Energy Solutions Limited</span> was established in <span className="font-semibold">December 2025</span> with a vision to bridge traditional and emerging energy services, focusing on delivering innovative solutions that empower businesses and communities across Africa and beyond.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              We provide comprehensive integrated energy solutions across the entire value chain—from reservoir studies and field operations to clean energy initiatives and digital transformation, supporting sustainable growth and operational excellence.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-gradient-to-br from-blue-900 to-blue-800 text-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-lg text-blue-100 leading-relaxed">
              To deliver innovative, reliable, and sustainable energy solutions that optimize performance, maximize resource recovery, and accelerate the energy transition, becoming the provider of choice for our clients.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-800 to-blue-900 text-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-lg text-blue-100 leading-relaxed">
              To be the leading and most trusted provider of choice for energy solutions in Africa and beyond, driving operational excellence, environmental stewardship, and long-term value for our clients and communities.
            </p>
          </div>
        </div>
