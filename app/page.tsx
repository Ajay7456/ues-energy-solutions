  ...
  const services = [
    {
      ...
      // Using Unsplash energy-related placeholder images
                ...
                <div className="h-48 relative overflow-hidden bg-blue-50">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = `https://images.unsplash.com/photo-1579532537598-459ecdaf39cc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80`;
                    }}
                  />
