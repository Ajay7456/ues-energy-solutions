        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {services.map((service) => (
              ...
              >
                {/* Image Container - Left side, vertically centered */}
                <div className="flex-shrink-0 w-48 h-48 md:w-56 md:h-56 m-6 flex items-center justify-center">
                  <div className="w-full h-full bg-white rounded-xl shadow-md border border-blue-100 overflow-hidden p-3 group-hover:scale-105 transition-transform duration-500">
                    <img
                      src={service.image}
                      alt={service.name}
                ...
                <div className="flex-grow p-6 flex flex-col justify-center h-full">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 group-hover:text-blue-900 transition-colors">
                    {service.name}
                  </h3>
                  <p className="text-gray-600 mb-4 text-base">
                    {service.desc}
                  </p>
                  <div className="flex items-center text-blue-900 font-medium group-hover:text-blue-700 transition-colors mt-2">
