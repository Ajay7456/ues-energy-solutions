          ...
          <div className="space-y-8">
            {services.map((service) => (
              <Link 
                key={service.id}
                href={service.link}
                className="group bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row items-center h-full"
              >
                {/* Image Box - Left side */}
                <div className="w-full md:w-2/5 p-6 flex items-center justify-center bg-gradient-to-br from-blue-50 to-white group-hover:from-blue-100 transition-all duration-500 min-h-[250px]">
                  <div className="relative w-48 h-48 bg-white rounded-2xl shadow-lg p-4 border border-blue-100">
                    <img
                      src={service.image}
                      alt={service.name}
