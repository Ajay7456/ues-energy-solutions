        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              ...
              >
                {/* Smaller image container - like larger icons */}
                <div className="relative overflow-hidden bg-blue-50 pt-[70%]"> {/* Reduced from pt-[75%] */}
                  <div className="absolute inset-0 flex items-center justify-center p-6"> {/* Increased padding */}
                    <img
                      src={service.image}
                      alt={service.name}
                      className="w-4/5 h-4/5 object-contain group-hover:scale-110 transition-transform duration-500" /* Smaller size */
                      loading="lazy"
                      style={{
                        maxWidth: '80%',
                        maxHeight: '80%'
